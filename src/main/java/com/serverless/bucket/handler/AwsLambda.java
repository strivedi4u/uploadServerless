package com.serverless.bucket.handler;
...
import com.serverless.bucket.BucketApplication;
...
import java.io.OutputStream;
    ...
    public class AwsLambda implements RequestStreamHandler {
        ...
        static {
            try {
                handler = SpringBootLambdaContainerHandler.getAwsProxyHandler(BucketApplication.class);
